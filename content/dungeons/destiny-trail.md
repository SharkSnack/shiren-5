...
<table id="monsterTable" class="monsterTable">
  ...
  <tbody>
    <tr>
      ...
      <td class="day"><div class="tooltip"><img src="../images/monsters_s/4-1.png"/> Seedie<div class="tooltiptext">- <span class="tipName">Seedie</span> -<br/><span class="tipHP">HP:</span> 7 <span class="tipAP">AP:</span> 7 <span class="tipDP">DP:</span> 1 <span class="tipExp">Exp:</span> 4 <span class="tipGP">GP:</span> 1<br/><span class="tipType">Type:</span> Plant <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>None.</div></div></td>
    ...
    <tr>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/44-5.png"/> Dark Boy Cart<div class="tooltiptext">- <span class="tipName">Dark Boy Cart</span> -<br/><span class="tipHP">HP:</span> 14 <span class="tipAP">AP:</span> 5 <span class="tipDP">DP:</span> 2 <span class="tipExp">Exp:</span> 3 <span class="tipGP">GP:</span> 8<br/><span class="tipType">Type:</span> Normal <span class="tipSpeed">Speed:</span> Swift 1<br/><span class="tipSpecial">Sp.Atk Rate:</span> 100% (near), 80% (far)<br/><span class="tipItem">Item Drop Rate:</span> 6%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks. Shoots Wood Arrows. Moves away if Shiren gets close. Can use direct attacks, and attacks even in hallways. Only drops Wood Arrows.</div></div></td>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/31-5.png"/> Dark Bored Kappa<div class="tooltiptext">- <span class="tipName">Dark Bored Kappa</span> -<br/><span class="tipHP">HP:</span> 14 <span class="tipAP">AP:</span> 5 <span class="tipDP">DP:</span> 2 <span class="tipExp">Exp:</span> 3 <span class="tipGP">GP:</span> 7<br/><span class="tipType">Type:</span> Aquatic <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks. Stands on an item and throws it at Shiren when he gets within 3 tiles. Catches projectiles and throws them back at Shiren. Items it throws always miss. Cannot throw weapons, shields, or Gitan.</div></div></td>
      <td class="highlightGray3 dangerNight"><div class="tooltip"><img src="../images/monsters_s/3-5.png"/> Bad Colum<div class="tooltiptext">- <span class="tipName">Bad Colum</span> -<br/><span class="tipHP">HP:</span> 14 <span class="tipAP">AP:</span> 5 <span class="tipDP">DP:</span> 2 <span class="tipExp">Exp:</span> 3 <span class="tipGP">GP:</span> 6<br/><span class="tipType">Type:</span> Normal <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks. Rolls backward 10 tiles when slain by a direct attack, damaging anything it hits equal to damage received.</div></div></td>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/5-5.png"/> Evil Chintala<div class="tooltiptext">- <span class="tipName">Evil Chintala</span> -<br/><span class="tipHP">HP:</span> 14 <span class="tipAP">AP:</span> 5 <span class="tipDP">DP:</span> 2 <span class="tipExp">Exp:</span> 3 <span class="tipGP">GP:</span> 4<br/><span class="tipType">Type:</span> Normal <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks.</div></div></td>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/1-5.png"/> Dark Mamel<div class="tooltiptext">- <span class="tipName">Dark Mamel</span> -<br/><span class="tipHP">HP:</span> 24 <span class="tipAP">AP:</span> 14 <span class="tipDP">DP:</span> 3 <span class="tipExp">Exp:</span> 22 <span class="tipGP">GP:</span> 15<br/><span class="tipType">Type:</span> Normal <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks.</div></div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="day"><div class="tooltip"><img src="../images/monsters_s/4-1.png"/> Seedie<div class="tooltiptext">- <span class="tipName">Seedie</span> -<br/><span class="tipHP">HP:</span> 7 <span class="tipAP">AP:</span> 7 <span class="tipDP">DP:</span> 1 <span class="tipExp">Exp:</span> 4 <span class="tipGP">GP:</span> 1<br/><span class="tipType">Type:</span> Plant <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>None.</div></div></td>
      <td class="day"><div class="tooltip"><img src="../images/monsters_s/2-1.png"/> Sproutant<div class="tooltiptext">- <span class="tipName">Sproutant</span> -<br/><span class="tipHP">HP:</span> 5 <span class="tipAP">AP:</span> 2 <span class="tipDP">DP:</span> 1 <span class="tipExp">Exp:</span> 3 <span class="tipGP">GP:</span> 2<br/><span class="tipType">Type:</span> Plant <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Monster family becomes immune to most recent status inflicted upon it, excluding Sealed status.</div></div></td>
      <td class="day"><div class="tooltip"><img src="../images/monsters_s/3-1.png"/> Colum<div class="tooltiptext">- <span class="tipName">Colum</span> -<br/><span class="tipHP">HP:</span> 7 <span class="tipAP">AP:</span> 7 <span class="tipDP">DP:</span> 1 <span class="tipExp">Exp:</span> 4 <span class="tipGP">GP:</span> 2<br/><span class="tipType">Type:</span> Normal <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Rolls backward 10 tiles when slain by a direct attack, damaging anything it hits equal to damage received.</div></div></td>
      <td></td>
    </tr>
    <tr>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/44-5.png"/> Dark Boy Cart<div class="tooltiptext">- <span class="tipName">Dark Boy Cart</span> -<br/><span class="tipHP">HP:</span> 14 <span class="tipAP">AP:</span> 5 <span class="tipDP">DP:</span> 2 <span class="tipExp">Exp:</span> 3 <span class="tipGP">GP:</span> 8<br/><span class="tipType">Type:</span> Normal <span class="tipSpeed">Speed:</span> Swift 1<br/><span class="tipSpecial">Sp.Atk Rate:</span> 100% (near), 80% (far)<br/><span class="tipItem">Item Drop Rate:</span> 6%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks. Shoots Wood Arrows. Moves away if Shiren gets close. Can use direct attacks, and attacks even in hallways. Only drops Wood Arrows.</div></div></td>
    ...
    <tr>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/26-5.png"/> Evil PolySpinna<div class="tooltiptext">- <span class="tipName">Evil PolySpinna</span> -<br/><span class="tipHP">HP:</span> 25 <span class="tipAP">AP:</span> 18 <span class="tipDP">DP:</span> 3 <span class="tipExp">Exp:</span> 26 <span class="tipGP">GP:</span> 13<br/><span class="tipType">Type:</span> Drain/Magic <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 23% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks. Lowers Max HP by 2 or Max Fullness by 5 when adjacent. Occasionally warps in front of Shiren when in a room.</div></div></td>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/8-5.png"/> Putrid Sweet Nut<div class="tooltiptext">- <span class="tipName">Putrid Sweet Nut</span> -<br/><span class="tipHP">HP:</span> 55 <span class="tipAP">AP:</span> 30 <span class="tipDP">DP:</span> 1 <span class="tipExp">Exp:</span> 70 <span class="tipGP">GP:</span> 35<br/><span class="tipType">Type:</span> Plant/Explode <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 0%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks. Either doubles experience points (Max: x1024) or explodes (33% chance) each time it eats a thrown item.</div></div></td>
      <td></td>
      <td></td>
      <td></td>
    </tr>
    ...
    <tr>
      ...
      <td class="day"><div class="tooltip"><img src="../images/monsters_s/1-2.png"/> Pit Mamel<div class="tooltiptext">- <span class="tipName">Pit Mamel</span> -<br/><span class="tipHP">HP:</span> 11 <span class="tipAP">AP:</span> 6 <span class="tipDP">DP:</span> 3 <span class="tipExp">Exp:</span> 5 <span class="tipGP">GP:</span> 2<br/><span class="tipType">Type:</span> Normal <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>None.</div></div></td>
      <td class="day"><div class="tooltip"><img src="../images/monsters_s/5-1.png"/> Chintala<div class="tooltiptext">- <span class="tipName">Chintala</span> -<br/><span class="tipHP">HP:</span> 19 <span class="tipAP">AP:</span> 9 <span class="tipDP">DP:</span> 4 <span class="tipExp">Exp:</span> 12 <span class="tipGP">GP:</span> 6<br/><span class="tipType">Type:</span> Normal <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>None.</div></div></td>
      <td class="day"><div class="tooltip"><img src="../images/monsters_s/2-1.png"/> Sproutant<div class="tooltiptext">- <span class="tipName">Sproutant</span> -<br/><span class="tipHP">HP:</span> 5 <span class="tipAP">AP:</span> 2 <span class="tipDP">DP:</span> 1 <span class="tipExp">Exp:</span> 3 <span class="tipGP">GP:</span> 2<br/><span class="tipType">Type:</span> Plant <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Monster family becomes immune to most recent status inflicted upon it, excluding Sealed status.</div></div></td>
      <td class="day"><div class="tooltip"><img src="../images/monsters_s/3-1.png"/> Colum<div class="tooltiptext">- <span class="tipName">Colum</span> -<br/><span class="tipHP">HP:</span> 7 <span class="tipAP">AP:</span> 7 <span class="tipDP">DP:</span> 1 <span class="tipExp">Exp:</span> 4 <span class="tipGP">GP:</span> 2<br/><span class="tipType">Type:</span> Normal <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Rolls backward 10 tiles when slain by a direct attack, damaging anything it hits equal to damage received.</div></div></td>
      <td class="day"><div class="tooltip"><img src="../images/monsters_s/9-1.png"/> Blade Bee<div class="tooltiptext">- <span class="tipName">Blade Bee</span> -<br/><span class="tipHP">HP:</span> 28 <span class="tipAP">AP:</span> 10 <span class="tipDP">DP:</span> 1 <span class="tipExp">Exp:</span> 5 <span class="tipGP">GP:</span> 4<br/><span class="tipType">Type:</span> Floating <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 16% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 0%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Occasionally retreats after attacking. Stinger has double AP and inflicts Confused status, but it also collapses afterward.</div></div></td>
    </tr>
    <tr>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/23-5.png"/> Dark Naptapir<div class="tooltiptext">- <span class="tipName">Dark Naptapir</span> -<br/><span class="tipHP">HP:</span> 24 <span class="tipAP">AP:</span> 14 <span class="tipDP">DP:</span> 3 <span class="tipExp">Exp:</span> 22 <span class="tipGP">GP:</span> 10<br/><span class="tipType">Type:</span> Normal <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 23% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks. Initially Napping, will not wake up when Shiren enters or exits the room. Occasionally inflicts Asleep status in a 1 tile radius when it's Napping, Asleep, or Sound Asleep. Chance to yawn when slain, inflicting Asleep status in a 1 tile radius.</div></div></td>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/31-5.png"/> Dark Bored Kappa<div class="tooltiptext">- <span class="tipName">Dark Bored Kappa</span> -<br/><span class="tipHP">HP:</span> 14 <span class="tipAP">AP:</span> 5 <span class="tipDP">DP:</span> 2 <span class="tipExp">Exp:</span> 3 <span class="tipGP">GP:</span> 7<br/><span class="tipType">Type:</span> Aquatic <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks. Stands on an item and throws it at Shiren when he gets within 3 tiles. Catches projectiles and throws them back at Shiren. Items it throws always miss. Cannot throw weapons, shields, or Gitan.</div></div></td>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/32-5.png"/> Evil Hopodile<div class="tooltiptext">- <span class="tipName">Evil Hopodile</span> -<br/><span class="tipHP">HP:</span> 24 <span class="tipAP">AP:</span> 12 <span class="tipDP">DP:</span> 3 <span class="tipExp">Exp:</span> 22 <span class="tipGP">GP:</span> 14<br/><span class="tipType">Type:</span> Dragon/Aquatic <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks. Moves like a chess knight when Shiren is in view. Performs a 15 damage jumping attack when Shiren is in range of a chess knight hop.</div></div></td>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/5-5.png"/> Evil Chintala<div class="tooltiptext">- <span class="tipName">Evil Chintala</span> -<br/><span class="tipHP">HP:</span> 14 <span class="tipAP">AP:</span> 5 <span class="tipDP">DP:</span> 2 <span class="tipExp">Exp:</span> 3 <span class="tipGP">GP:</span> 4<br/><span class="tipType">Type:</span> Normal <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks.</div></div></td>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/1-5.png"/> Dark Mamel<div class="tooltiptext">- <span class="tipName">Dark Mamel</span> -<br/><span class="tipHP">HP:</span> 24 <span class="tipAP">AP:</span> 14 <span class="tipDP">DP:</span> 3 <span class="tipExp">Exp:</span> 22 <span class="tipGP">GP:</span> 15<br/><span class="tipType">Type:</span> Normal <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks.</div></div></td>
    </tr>
    <tr>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/26-5.png"/> Evil PolySpinna<div class="tooltiptext">- <span class="tipName">Evil PolySpinna</span> -<br/><span class="tipHP">HP:</span> 25 <span class="tipAP">AP:</span> 18 <span class="tipDP">DP:</span> 3 <span class="tipExp">Exp:</span> 26 <span class="tipGP">GP:</span> 13<br/><span class="tipType">Type:</span> Drain/Magic <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 23% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks. Lowers Max HP by 2 or Max Fullness by 5 when adjacent. Occasionally warps in front of Shiren when in a room.</div></div></td>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/8-5.png"/> Putrid Sweet Nut<div class="tooltiptext">- <span class="tipName">Putrid Sweet Nut</span> -<br/><span class="tipHP">HP:</span> 55 <span class="tipAP">AP:</span> 30 <span class="tipDP">DP:</span> 1 <span class="tipExp">Exp:</span> 70 <span class="tipGP">GP:</span> 35<br/><span class="tipType">Type:</span> Plant/Explode <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 0%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks. Either doubles experience points (Max: x1024) or explodes (33% chance) each time it eats a thrown item.</div></div></td>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/13-5.png"/> Dark Tosser<div class="tooltiptext">- <span class="tipName">Dark Tosser</span> -<br/><span class="tipHP">HP:</span> 16 <span class="tipAP">AP:</span> 9 <span class="tipDP">DP:</span> 1 <span class="tipExp">Exp:</span> 10 <span class="tipGP">GP:</span> 18<br/><span class="tipType">Type:</span> Normal <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 33% (near), 33% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks. Throws an adjacent creature at Shiren, or throws Shiren at another creature, onto a trap, or into a Monster House. Range of 5 tiles, deals 10 damage.</div></div></td>
      <td></td>
      <td></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="day"><div class="tooltip"><img src="../images/monsters_s/1-2.png"/> Pit Mamel<div class="tooltiptext">- <span class="tipName">Pit Mamel</span> -<br/><span class="tipHP">HP:</span> 11 <span class="tipAP">AP:</span> 6 <span class="tipDP">DP:</span> 3 <span class="tipExp">Exp:</span> 5 <span class="tipGP">GP:</span> 2<br/><span class="tipType">Type:</span> Normal <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>None.</div></div></td>
      <td class="day"><div class="tooltip"><img src="../images/monsters_s/5-1.png"/> Chintala<div class="tooltiptext">- <span class="tipName">Chintala</span> -<br/><span class="tipHP">HP:</span> 19 <span class="tipAP">AP:</span> 9 <span class="tipDP">DP:</span> 4 <span class="tipExp">Exp:</span> 12 <span class="tipGP">GP:</span> 6<br/><span class="tipType">Type:</span> Normal <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>None.</div></div></td>
      <td class="day farm"><div class="tooltip"><img src="../images/monsters_s/6-1.png"/> Grass Kid<div class="tooltiptext">- <span class="tipName">Grass Kid</span> -<br/><span class="tipHP">HP:</span> 28 <span class="tipAP">AP:</span> 10 <span class="tipDP">DP:</span> 1 <span class="tipExp">Exp:</span> 5 <span class="tipGP">GP:</span> 3<br/><span class="tipType">Type:</span> Plant <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 21% (near), 16% (far)<br/><span class="tipItem">Item Drop Rate:</span> 0%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Spreads grass in a 1 tile radius when adjacent. Pierce-throws grass in a straight line at a distance. Carries 1 grass item. Becomes Pin Kid with 0 grass.</div></div></td>
      <td class="day"><div class="tooltip"><img src="../images/monsters_s/7-1.png"/> Pin Kid<div class="tooltiptext">- <span class="tipName">Pin Kid</span> -<br/><span class="tipHP">HP:</span> 28 <span class="tipAP">AP:</span> 8 <span class="tipDP">DP:</span> 1 <span class="tipExp">Exp:</span> 5 <span class="tipGP">GP:</span> 1<br/><span class="tipType">Type:</span> Plant <span class="tipSpeed">Speed:</span> Swift 1<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 0%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Runs from Shiren, but attacks when adjacent. Becomes Grass Kid when it picks up a grass item.</div></div></td>
      <td class="day"><div class="tooltip"><img src="../images/monsters_s/9-1.png"/> Blade Bee<div class="tooltiptext">- <span class="tipName">Blade Bee</span> -<br/><span class="tipHP">HP:</span> 28 <span class="tipAP">AP:</span> 10 <span class="tipDP">DP:</span> 1 <span class="tipExp">Exp:</span> 5 <span class="tipGP">GP:</span> 4<br/><span class="tipType">Type:</span> Floating <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 16% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 0%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Occasionally retreats after attacking. Stinger has double AP and inflicts Confused status, but it also collapses afterward.</div></div></td>
    </tr>
    <tr>
      <td></td>
      ...
      <td></td>
      <td></td>
      <td class="day"><div class="tooltip"><img src="../images/monsters_s/8-1.png"/> Sweet Nut<div class="tooltiptext">- <span class="tipName">Sweet Nut</span> -<br/><span class="tipHP">HP:</span> 16 <span class="tipAP">AP:</span> 11 <span class="tipDP">DP:</span> 5 <span class="tipExp">Exp:</span> 15 <span class="tipGP">GP:</span> 4<br/><span class="tipType">Type:</span> Plant/Explode <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 0%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Either doubles experience points (Max: x1024) or explodes (33% chance) each time it eats a thrown item.</div></div></td>
    </tr>
    <tr>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/23-5.png"/> Dark Naptapir<div class="tooltiptext">- <span class="tipName">Dark Naptapir</span> -<br/><span class="tipHP">HP:</span> 24 <span class="tipAP">AP:</span> 14 <span class="tipDP">DP:</span> 3 <span class="tipExp">Exp:</span> 22 <span class="tipGP">GP:</span> 10<br/><span class="tipType">Type:</span> Normal <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 23% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks. Initially Napping, will not wake up when Shiren enters or exits the room. Occasionally inflicts Asleep status in a 1 tile radius when it's Napping, Asleep, or Sound Asleep. Chance to yawn when slain, inflicting Asleep status in a 1 tile radius.</div></div></td>
      <td class="highlightGray3 dangerNight"><div class="tooltip"><img src="../images/monsters_s/46-5.png"/> Dark Absorbiphant<div class="tooltiptext">- <span class="tipName">Dark Absorbiphant</span> -<br/><span class="tipHP">HP:</span> 10 <span class="tipAP">AP:</span> 5 <span class="tipDP">DP:</span> 1 <span class="tipExp">Exp:</span> 3 <span class="tipGP">GP:</span> 20<br/><span class="tipType">Type:</span> Drain <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 100% (near), 100% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks. Absorbs status conditions inflicted on itself or from a creature within a 1 tile radius, fully restoring its own HP and raising AP by 1 stage.</div></div></td>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/32-5.png"/> Evil Hopodile<div class="tooltiptext">- <span class="tipName">Evil Hopodile</span> -<br/><span class="tipHP">HP:</span> 24 <span class="tipAP">AP:</span> 12 <span class="tipDP">DP:</span> 3 <span class="tipExp">Exp:</span> 22 <span class="tipGP">GP:</span> 14<br/><span class="tipType">Type:</span> Dragon/Aquatic <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks. Moves like a chess knight when Shiren is in view. Performs a 15 damage jumping attack when Shiren is in range of a chess knight hop.</div></div></td>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/12-5.png"/> Dark Karakuroid<div class="tooltiptext">- <span class="tipName">Dark Karakuroid</span> -<br/><span class="tipHP">HP:</span> 10 <span class="tipAP">AP:</span> 8 <span class="tipDP">DP:</span> 1 <span class="tipExp">Exp:</span> 2 <span class="tipGP">GP:</span> 25<br/><span class="tipType">Type:</span> Metal <span class="tipSpeed">Speed:</span> Swift 1<br/><span class="tipSpecial">Sp.Atk Rate:</span> 38% (near), 38% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks. Initially Napping, wakes when Shiren enters or exits the room. Creates a trap on the ground, then stops acting for 2 turns. Occasionally creates a trap when slain.</div></div></td>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/1-5.png"/> Dark Mamel<div class="tooltiptext">- <span class="tipName">Dark Mamel</span> -<br/><span class="tipHP">HP:</span> 24 <span class="tipAP">AP:</span> 14 <span class="tipDP">DP:</span> 3 <span class="tipExp">Exp:</span> 22 <span class="tipGP">GP:</span> 15<br/><span class="tipType">Type:</span> Normal <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks.</div></div></td>
    </tr>
    <tr>
      <td class="highlightGray3 itemsNight"><div class="tooltip"><img src="../images/monsters_s/38-5.png"/> Violent Gyadon<div class="tooltiptext">- <span class="tipName">Violent Gyadon</span> -<br/><span class="tipHP">HP:</span> 10 <span class="tipAP">AP:</span> 5 <span class="tipDP">DP:</span> 1 <span class="tipExp">Exp:</span> 4 <span class="tipGP">GP:</span> 18<br/><span class="tipType">Type:</span> Floating <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 21% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks. Pecks a staff from your inventory when adjacent, reducing its charges to 0.</div></div></td>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/8-5.png"/> Putrid Sweet Nut<div class="tooltiptext">- <span class="tipName">Putrid Sweet Nut</span> -<br/><span class="tipHP">HP:</span> 55 <span class="tipAP">AP:</span> 30 <span class="tipDP">DP:</span> 1 <span class="tipExp">Exp:</span> 70 <span class="tipGP">GP:</span> 35<br/><span class="tipType">Type:</span> Plant/Explode <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 0% (near), 0% (far)<br/><span class="tipItem">Item Drop Rate:</span> 0%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks. Either doubles experience points (Max: x1024) or explodes (33% chance) each time it eats a thrown item.</div></div></td>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/13-5.png"/> Dark Tosser<div class="tooltiptext">- <span class="tipName">Dark Tosser</span> -<br/><span class="tipHP">HP:</span> 16 <span class="tipAP">AP:</span> 9 <span class="tipDP">DP:</span> 1 <span class="tipExp">Exp:</span> 10 <span class="tipGP">GP:</span> 18<br/><span class="tipType">Type:</span> Normal <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 33% (near), 33% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks. Throws an adjacent creature at Shiren, or throws Shiren at another creature, onto a trap, or into a Monster House. Range of 5 tiles, deals 10 damage.</div></div></td>
      <td class="highlightGray3"><div class="tooltip"><img src="../images/monsters_s/34-5.png"/> Sinful Yanpii<div class="tooltiptext">- <span class="tipName">Sinful Yanpii</span> -<br/><span class="tipHP">HP:</span> 10 <span class="tipAP">AP:</span> 5 <span class="tipDP">DP:</span> 1 <span class="tipExp">Exp:</span> 10 <span class="tipGP">GP:</span> 40<br/><span class="tipType">Type:</span> Normal <span class="tipSpeed">Speed:</span> Normal<br/><span class="tipSpecial">Sp.Atk Rate:</span> 22% (near), 22% (far)<br/><span class="tipItem">Item Drop Rate:</span> 4%<br/>~ <span class="tipAbility">Ability</span> ~<br/>Resists non-ability attacks. Headbutts Shiren when lined up, dealing 15 damage and knockback based on distance traveled. If Shiren is knocked into a wall, go into the wall 1 tile and take an additional 10 damage.</div></div></td>
      <td></td>
    </tr>
    <tr>
      <td colspan="6" class="purpleDivider"></td>
