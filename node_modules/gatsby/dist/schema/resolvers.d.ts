...
export declare const min: GatsbyResolver<IGatsbyConnection<any>, IFieldConnectionArgs>;
export declare const max: GatsbyResolver<IGatsbyConnection<any>, IFieldConnectionArgs>;
export declare const sum: GatsbyResolver<IGatsbyConnection<any>, IFieldConnectionArgs>;
