...
function loadPlugins(config = {}, rootDir) {
  ...
  const internalPlugins = [`../../internal-plugins/dev-404-page`, `../../internal-plugins/load-babel-config`, `../../internal-plugins/internal-data-bridge`, `../../internal-plugins/prod-404`, `../../internal-plugins/webpack-theme-component-shadowing`, `../../internal-plugins/bundle-optimisations`, process.env.GATSBY_EXPERIMENTAL_FUNCTIONS && `../../internal-plugins/functions`].filter(Boolean);
