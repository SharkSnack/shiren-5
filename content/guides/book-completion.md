...
<div class="pageTopImage screenshot">
  <img src="../images/other/book.png"/>
</div>

# Overview

The encyclopedia keeps a record of items you've obtained and monsters you've defeated.<br/>Each entry has its own visual preview and description, some of which can be pretty humorous.
...
- Water Cutter
- Scythe --- Tanuki Password: <span class="greenText">Vegicide</span>
- Myopic Masher
- Magic Masher
- Drain Dagger
- Copper Cleaver
...
- Shoddy Dirk
- Glass Dirk
- Dirk of Debts --- Tanuki Password: <span class="greenText">Treasury</span>
- Extreme Sword --- Tanuki Password: <span class="greenText">Critical</span>
- Violent Blade --- Tanuki Password: <span class="greenText">Cursed Blade</span>
- Breeze Blade
- Burning Blade
...
- Diet Shield
- Heavy Shield
- Midnight Shield --- Tanuki Password: <span class="greenText">Carpe Noctem</span>
- Day Shield --- Tanuki Password: <span class="greenText">Carpe Diem</span>
- Binary Shield
...
- Pauper's Plank --- Tanuki Password: <span class="greenText">Golddigger</span>
- Rush Shield --- Tanuki Password: <span class="greenText">O-FENCE!</span>
- Blazing Shield
...
- Growth Bracelet
- Heal Bracelet
- Bunch Bracelet --- Tanuki Password: <span class="greenText">Arms Race</span>
- Mojo Bracelet
...
- Wall Clip Bracelet
- VIP Bracelet
- Nonary Bracelet --- Tanuki Password: <span class="greenText">Nonary Game</span>
...
- Stomach Shrinker
- Weeds
- Revival Grass --- Tanuki Password: <span class="greenText">I Love Zombies!</span>
- Undo Grass --- Tanuki Password: <span class="greenText">Lost and Found</span>
- Confusion Grass
- Blinding Grass
...
- Sleep Grass
- Rage Grass
- Cheery Grass --- Tanuki Password: <span class="greenText">Happy Grass</span>
- Angel Seed
- Unlucky Seed
- SuperUnlucky Seed
- Amnesia Grass
...
- Blank Scroll --- Tanuki Password: <span class="greenText">Carte Blanche</span>
- Coupon Scroll --- Tanuki Password: <span class="greenText">Coupon Scroll</span>
- Arbor Scroll
- Mate Scroll
- Darth Scroll
- Pot Dog Scroll
...
- Preservation Pot
- Ordinary Pot
- Synthesis Pot --- Tanuki Password: <span class="greenText">Synthesis Pot</span>
- Sale Pot
- Presto Pot
- Identify Pot
- Exorcism Pot
...
- Curse Pot
- Black Hole Pot
- Fever Pot --- Tanuki Password: <span class="greenText">All Lucky 7s</span>
- Sticky Pot
- Hide Pot
- Unbreakable Pot
...
- Heal Pot
- Hilarious Pot --- Tanuki Password: <span class="greenText">Pot O' Laughs</span>
- Zalokleft Pot
- Klein Pot
- Monster Pot
...
- Zen Pot
- Dodger Pot --- Tanuki Password: <span class="greenText">Miss Mist</span>
- Perceptive Pot
- Reflection Pot
...
- Fort. Staff
- Ordinary Staff
- Drama Staff --- Tanuki Password: <span class="greenText">Shakespeare</span>
- Sharing Staff
...
The Floramorph Pot in Statue Cave (<span class="orangeText">What you need is...?</span>) can be used to obtain all flowers.

- Gitan --- Tanuki Password: <span class="greenText">Tao's Stash</span>
- Point Card --- Obtained at the Point Shop after Hotel Nekomaneki basement event.
- Red Cat --- Tanuki Password: <span class="greenText">Banana Prince</span>
- Orange Cat --- Tanuki Password: <span class="greenText">Pumphantasm</span>
- Yellow Cat --- Tanuki Password: <span class="greenText">Kitty Cat</span>
- Green Cat --- Tanuki Password: <span class="greenText">Green Grass</span>
- Blue Cat --- Tanuki Password: <span class="greenText">Chunsoft</span>

#### Page 2

- Indigo Cat --- Tanuki Password: <span class="greenText">Shinya Kano</span>
- Purple Cat --- Tanuki Password: <span class="greenText">Perfect</span>
